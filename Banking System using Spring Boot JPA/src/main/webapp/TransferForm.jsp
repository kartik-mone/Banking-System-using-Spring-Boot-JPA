...
<head>
    <meta charset="UTF-8">
    <title>Fund Transfer - NetBanking Admin</title>
    <style>
        body {
...
<div class="header">
    <h1>Fund Transfer</h1>
    <p>Transfer money from one account to another securely.</p>
...
<div class="form-wrapper">
    <form action="/transferamount" method="post" class="transfer-form">
        <h2>Fund Transfer Form</h2>

        <!-- Show success or error messages -->
        <c:if test="${not empty message}">
            <div class="alert alert-success"><center> ${message} </center>${message}</div>
        </c:if>
        ...
        <div class="form-group">
        	<label for="fromaccount">From Account Number</label>
       		<input type="text" name="fromaccount" id="fromaccount" required />
	    </div>
	
	    <div class="form-group">
	        <label for="toaccount">To Account Number</label>
	        <input type="text" name="toaccount" id="toaccount" required />
	    </div>
